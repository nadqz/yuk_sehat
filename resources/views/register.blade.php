...
<head>
  ...
  <style>
    ...
    .logo h1 { font-size: 22px; margin: 0 0 25px 0; color: var(--emerald-deep); }
  </style>
</head>
...
<body>
  ...
  <div class="login-wrapper">
    <div class="login-card">
      ...
      <p style="font-size: 13px; color: var(--text-muted); margin-bottom: 25px;">Bergabunglah untuk memulai gaya hidup sehat</p>
      ...
      <form method="POST" action="{{ route('register') }}">
        ...
        <input name="name" type="text" placeholder="Nama Lengkap" value="{{ old('name') }}" required autofocus />
