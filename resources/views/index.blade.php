...
<body>
    ...
    <section class="features" id="fitur">
        ...
        <div class="feature-grid">
            <div class="feature-card">
                ...
                <h3>Analisis BMI</h3>
                <p style="font-size: 13px;">Pantau komposisi tubuh secara berkala. Simpan riwayat berat badan Anda dan lihat grafiknya meningkat.</p>
            </div>
            ...
            <div class="feature-card">
                ...
                <p style="font-size: 13px;">Catat langkah kaki dan durasi olahraga. Bagikan progres harian Anda untuk menjaga motivasi tetap tinggi.</p>
            </div>
            ...
            <div class="feature-card">
                ...
                <p style="font-size: 13px;">Pastikan tubuh mendapatkan asupan air yang cukup. Log setiap gelas air yang Anda minum dengan satu sentuhan.</p>
            </div>
        </div>
    </section>
    ...
    <section class="about" id="tentang">
        ...
        <div class="about-text">
            ...
            <p style="font-size: 13px;">Kami percaya kesehatan dimulai dari konsistensi mencatat hal-hal kecil. Dengan <strong>Yuk Sehat!!</strong>, Anda tidak perlu lagi menebak-nebak progres kesehatan Anda.</p>
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-top: 30px;">
                <div>
                    <h4 style="color: var(--emerald-mid); font-size: 20px;">Simple</h4>
                    <p style="font-size: 13px;">Input data hanya butuh waktu 30 detik.</p>
                </div>
                <div>
                    <h4 style="color: var(--emerald-mid); font-size: 20px;">Personal</h4>
                    <p style="font-size: 13px;">Insight yang disesuaikan dengan kondisi tubuh Anda.</p>
                </div>
            </div>
        </div>
    </section>
